...
function About() {
  return (
    <div className="text-white text-left bg-opacity-100 rounded-md md:m-10">
      <p className="text-md md:text-2xl mb-5 md:mb-10">I’m Sama, an Egyptian-American student currently in my third year, set to graduate in Spring 2026. 
      ...
      {/* link resume */}
      <p className='text-md md:text-2xl text-left font-medium'><a href={Resume} target="_blank" rel="noreferrer" className='text-white hover:text-[#C72D2D] underline'>Check my Resume Here</a></p>
    </div>
  );
}
...
function Interests() {
  ...
  return (
    <div className='md:m-10'>
      <h1 className="text-xl md:text-2xl underline mb-10 text-left text-[#C72D2D]">Interests</h1>
...
function Skills() {
  ...
  return (
    <div className='md:m-10'>
      <h1 className="text-xl md:text-2xl underline mb-10 text-left text-[#C72D2D]">Skills</h1>
